...
import com.putt2gether.adapter.WheelViewAdapter;
import com.putt2gether.config.DefaultConfig;
...
//        mPaintLineRight.setStrokeWidth(context.getResources().getDimensionPixelSize(R.dimen.picker_line_width));
    ...
    private int getDesiredHeight(LinearLayout layout) {
        ...
        return Math.max(200, getSuggestedMinimumHeight());
    }
...
//        centerDrawable.draw(canvas);
    ...
    private void createItemsLayout() {
        if (itemsLayout == null) {
            ...
            itemsLayout.setBackgroundResource(R.color.action);
