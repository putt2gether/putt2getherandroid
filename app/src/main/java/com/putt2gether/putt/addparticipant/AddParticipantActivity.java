...
public class AddParticipantActivity  extends AppCompatActivity {
    ...
    private void venueToolbar() {
        ...
        toolbarTitle.setText("ADD PARTICIPANT");
    ...
    class CreateTabFragmentAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            if (position == 0) {
                fragment = new PartiSuggestionFragment(event_id);
            } else if (position == 1) {
                fragment = new PartiGroupFragment(event_id);
            } else if (position == 2) {
                fragment = new PartiCreateFragment(event_id);
            } else if (position == 3) {
