 ...
 */
public class PartiGroupFragment  extends android.support.v4.app.Fragment implements PartiGroupAdapter.AddGroupAdapterCallback{
    private RecyclerView ddRecyclerView;
    private PartiGroupAdapter ddAdapter;
    ...
    public PartiGroupFragment(String event_id) {
        event_ID = event_id;
    }

    public PartiGroupFragment() {
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        ddRecyclerView = (RecyclerView)getActivity(). findViewById(R.id.groups_list);
    ...
    private void getGroupListResponse(JSONObject response){
        ...
        if (list.size()>0) {
            ddAdapter = new PartiGroupAdapter(getActivity(), list);
