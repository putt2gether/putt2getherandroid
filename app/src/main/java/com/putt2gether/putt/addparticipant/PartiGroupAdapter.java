 ...
 */
public class PartiGroupAdapter  extends RecyclerView.Adapter<PartiGroupAdapter.ViewHolder> implements Filterable,ItemTouchHelperAdapter {
    ...
    SharedPreferences addPartiSharedPreferences;
    ...
    public PartiGroupAdapter(Context mContext,ArrayList<GroupsBean> list) {
    ...
    @Override
    public PartiGroupAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(final PartiGroupAdapter.ViewHolder holder, final int position) {

        addPartiSharedPreferences = context.getSharedPreferences("add_participant", Context.MODE_PRIVATE);
        ...
        if (list.get(position).getIsAdded().equalsIgnoreCase("1")){
