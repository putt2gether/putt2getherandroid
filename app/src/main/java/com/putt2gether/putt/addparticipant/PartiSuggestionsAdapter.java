 ...
 */
public class PartiSuggestionsAdapter  extends RecyclerView.Adapter<PartiSuggestionsAdapter.SimpleViewHolder> implements Filterable,ItemTouchHelperAdapter {
    ...
    public PartiSuggestionsAdapter(Context context,ArrayList<SuggestionBean> data) {
        mContext = context;
        if (data != null) {
            mData = data;
    ...
    public void onBindViewHolder(final SimpleViewHolder holder, final int position) {
        ...
        addPartiSharedPreferences = mContext.getSharedPreferences("add_participant", Context.MODE_PRIVATE);
        ...
        if (mData.get(position).getIsAdded().equalsIgnoreCase("1")){
            ...
            holder.addIcon.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (top < noPlayer-1) {
                      ...
                      /*  for (int i=0;i<top;i++) {
                            String id1 = mData.get(i).getUser_id();
