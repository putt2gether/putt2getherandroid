...
import com.putt2gether.fragments.TeamCreateFragment;
import com.putt2gether.fragments.TeamSuggetion;
import com.putt2gether.fragments.WhatsAppFragments;

/**
 * Created by Ajay on 11/07/2016.
 */
public class TeamTabLayout extends AppCompatActivity {

    private RelativeLayout toolbar;
    private TabLayout tabLayout;
    private ViewPager viewPager;
    private String title[] = {"SUGGESTIONS","+ ADD PLAYER","WHATS APP"};
    ...
    private void venueToolbar() {
        ...
        toolbarTitle.setText("SUGGESTIONS");
