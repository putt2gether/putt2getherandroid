 ...
 */
public class NearGolfCoureForInvite  extends android.support.v4.app.Fragment {
    ...
    private NearGolfCourseAdapterInvite golfCorseAdapter;
    ...
    private void getGolfListResponse(JSONObject response){
        ...
        if(response != null){
            try{
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    typeBean.setHasEvent(jsonArray.getJSONObject(i).getString("has_event"));
        ...
        golfCorseAdapter = new NearGolfCourseAdapterInvite(getActivity(),list1);
