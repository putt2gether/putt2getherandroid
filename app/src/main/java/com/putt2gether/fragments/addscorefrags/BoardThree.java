 ...
 */
public class BoardThree extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.board_third, container, false);


        recyclerboardsecond=(RecyclerView)v.findViewById(R.id.recycler_board_third);

        feetOrYard = (TextView)v.findViewById(R.id.holesplayed_net);

        isSpotType = ((Leaderboard) getActivity()).isSpotType(1);
        tab_ID= ((Leaderboard) getActivity()).tabID(1);
    ...
    public void getLeaderBoard(String Event_Id) {
        ...
        Log.v("leaderTab",jsonObject.toString());
