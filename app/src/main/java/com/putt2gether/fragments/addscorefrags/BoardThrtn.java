 ...
 */
public class BoardThrtn  extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        tab_ID= ((Leaderboard) getActivity()).tabID(11);

        isSpotType = ((Leaderboard) getActivity()).isSpotType(11);
    ...
    public void getLeaderBoard(String Event_Id) {
        ...
        Utility.showLogError(getActivity(), "Error in " + "GET_leaderboard URL = " + PUTTAPI.GETLATESTFULLSCORE);
